...
apt-get update
apt-get install -y nginx postgresql postgresql-contrib nodejs npm certbot python3-certbot-nginx
...
sudo -u postgres psql -d $PG_DB -f database.sql
...
DOMAIN=$(grep VITE_SERVER_IP .env | cut -d '=' -f2)
...
# --- Start Services ---
print_color "32" "Starting services..."
