...
const index = 5;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-C1MURg2t.js')).default;
...
const stylesheets = ["_app/immutable/assets/bootstrap.6KA-2mUj.css","_app/immutable/assets/5.cc-_8U8C.css"];
const fonts = [];

export { component, fonts, imports, index, _page_server_ts as server, server_id, stylesheets };
//# sourceMappingURL=5-CT0csiFT.js.map
