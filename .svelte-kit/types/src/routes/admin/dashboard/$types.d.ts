...
type LayoutRouteId = RouteId | "/admin/dashboard"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/admin/dashboard/+layout.server.js').load>>>>>>;
